...
week3: bin/week3/opdracht1 bin/week3/opdracht3 bin/week3/opdracht3
...
bin/week3/opdracht1: $(call rwildcard,./week3/opdracht1,*.cpp)
    g++ -g -O0 -std=c++11 $^ -o $@ -lgdi32 -DESRI_WINDOWS $(INC)

bin/week3/opdracht2: $(call rwildcard,./week3/opdracht2,*.cpp)
    g++ -g -O0 -std=c++11 $^ -o $@ -lgdi32 -DESRI_WINDOWS $(INC)

bin/week3/opdracht3: $(call rwildcard,./week3/opdracht3,*.cpp)
    g++ -g -O0 -std=c++11 $^ -o $@ -lgdi32 -DESRI_WINDOWS $(INC)